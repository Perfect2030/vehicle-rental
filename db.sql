...
insert into `vehicle` (`licensePlate`, `model`, `brand`, `pricePerDay`, `status`, `isDeleted`) values
('59A1-12345', 'Vision 2024', 'Honda', 150000, 'AVAILABLE', false),
('59A1-23456', 'Air Blade 160', 'Honda', 220000, 'AVAILABLE', false),
('59B2-34567', 'Exciter 155', 'Yamaha', 250000, 'RENTED', false),
('59B2-45678', 'Sirius FI', 'Yamaha', 130000, 'AVAILABLE', false),
('59C3-56789', 'Lead 125', 'Honda', 180000, 'AVAILABLE', false),
('59C3-67890', 'Janus', 'Yamaha', 140000, 'RENTED', false),
('59D4-11111', 'SH Mode', 'Honda', 280000, 'MAINTENANCE', false),
('59D4-22222', 'Wave Alpha', 'Honda', 120000, 'AVAILABLE', false),
('59E5-33333', 'NVX 155', 'Yamaha', 230000, 'AVAILABLE', false),
('59E5-44444', 'Winner X', 'Honda', 240000, 'RENTED', false),
('59F6-55555', 'Grande', 'Yamaha', 170000, 'AVAILABLE', false),
('59F6-66666', 'Vario 160', 'Honda', 260000, 'AVAILABLE', false),
('59G7-77777', 'SH 125i', 'Honda', 320000, 'MAINTENANCE', false),
('59G7-88888', 'Future 125', 'Honda', 160000, 'AVAILABLE', false),
('59H8-99999', 'PG-1', 'Yamaha', 200000, 'AVAILABLE', false),
('59H8-12121', 'FreeGo', 'Yamaha', 150000, 'RENTED', false),
('59K9-34343', 'Blade 110', 'Honda', 110000, 'AVAILABLE', true),
('59K9-56565', 'Jupiter', 'Yamaha', 145000, 'AVAILABLE', false);
